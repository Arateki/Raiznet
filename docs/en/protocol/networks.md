...
This page specifies the federated network layer — topics, manifests, filters, and total replication. It is **not implemented yet**: today nodes are independent and replication is in design ([ADR-004](/en/adr/004-raiznet-native-replication)). See the [Roadmap](/en/guide/roadmap).
:::
