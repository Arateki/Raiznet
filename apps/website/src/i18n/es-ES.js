export const esES = {
  ...
  seo: {
    title: 'Raiznet | Red descentralizada para agricultura conectada',
    description:
      'Raiznet conecta sensores, servidores y productores en una red local-first para monitoreo de cultivos e inteligencia agricola colectiva.',
  },
  nav: {
